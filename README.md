...
|---------|-------------|--------------|---------|----------|--------------|----------|--------------|  
|Разрешает|Движение     |Движение      |Разрешает|Движение  |Движение      |Движение  |Движение      |  
|движение |мотором M1   |мотором M1    |движение |мотором M2|мотором M2    |мотором M3|мотором M3    |  
|моторами |по часовой   |против часовой|мотору M1|по часовой|против часовой|по часовой|против часовой|  
|M2 и M3  |стрелке      |стрелки       |         |стрелке   |стрелки       |стрелке   |стрелки       |  
